...
export default function CallSummary({ data, onRestart }) {
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-slate-50 to-slate-200 p-6 font-sans">
            <motion.div
            ...
            >
                ...
                <div className="p-12 space-y-10">
                    ...
                    <div className="flex flex-col gap-4 pt-4">
                        <button
                            onClick={onRestart}
                            className="w-full py-4 bg-slate-900 hover:bg-slate-800 text-white rounded-xl font-bold text-lg transition-transform active:scale-[0.98] shadow-lg hover:shadow-xl"
                        >
